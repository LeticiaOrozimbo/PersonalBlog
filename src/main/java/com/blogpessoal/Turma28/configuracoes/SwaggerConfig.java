...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Leticia Orozimbo", "https://github.com/LeticiaOrozimbo/PersonalBlog.git",
				"leticia-dospassos@hotmail.com");
	}
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/LeticiaOrozimbo/PersonalBlog.git").contact(contact()).build();
	}
